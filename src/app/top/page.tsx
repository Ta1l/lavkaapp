...
export default async function TopUsersPage() {
  ...
  return (
    <div className="bg-black min-h-screen rounded-[20px] text-white relative">
      <main className="overflow-y-auto" style={{ height: "calc(100vh - 70px)" }}>
        <div className="p-[25px] pt-[30px] pb-[90px]">
